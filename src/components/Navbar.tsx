...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center overflow-hidden max-w-[1440px] mx-auto'>
      ...
      <nav
        id='desktop-nav'
        className='hidden sm:inline-block bg-white backdrop-blur-lg bg-opacity-5 text-lg md:text-xl lg:text-2xl relative'
      >
        <ul className='flex h-24 items-center gap-9 lg:gap-12 px-12 xl:px-28'>
          <li
            className={`${location.pathname === '/' ? 'active-link' : ''} after:w-[34px] md:after:w-[37px]
          lg:after:w-[76px]`}
          >
            <Link to='/'>
              <span>00&nbsp;</span> Home
          ...
          <li
            className={`${location.pathname.includes('/destination') ? 'active-link' : ''} after:w-[78px] md:after:w-[87px]
          lg:after:w-[132px]`}
          >
            <Link to='/destination'>
          ...
          <li
            className={`${location.pathname.includes('/crew') ? 'active-link' : ''} after:w-[35px] md:after:w-[39px]
          lg:after:w-[78px]`}
          >
            <Link to='/crew'>
              <span>02&nbsp;</span> Crew
          ...
          <li
            className={`${location.pathname.includes('/technology') ? 'active-link' : ''} after:w-[88px] md:after:w-[98px]
          lg:after:w-[148px]`}
          >
            <Link to='/technology'>
              <span>03&nbsp;</span> Technoology
            </Link>
          </li>
        </ul>
      </nav>
      ...
      <nav
        id='mobile-nav'
        className={`sm:hidden bg-black bg-opacity-5 backdrop-blur-lg w-[70%] fixed top-0 p-8 pt-28 text-2xl
